<template>
  <div class="difficulty_wrapper">
    <div
      ref="easy"
      @mouseenter="toggleEasy"
      @mouseleave="toggleEasy"
    ...
    <div
      ref="meduim"
      @mouseenter="toggleMedium"
      @mouseleave="toggleMedium"
    ...
    <div
      ref="hard"
      @mouseenter="toggleHard"
      @mouseleave="toggleHard"
...
export default {
  ...
  methods: {
    ...
    toggleMedium() {
      if (this.difficulty === "easy" && this.allowDividerTwo) {
        this.dividerTwo = !this.dividerTwo;
      }
      if (this.difficulty === "hard" && this.allowDividerOne) {
        this.dividerOne = !this.dividerOne;
      }
    },
    toggleHard() {
