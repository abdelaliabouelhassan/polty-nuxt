...
<div class="wrapper">
    <div v-if="_header" class="product_card_header">
        ...
        <div class="title-header">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 31.98 35.667">
                <g id="Group_2843" data-name="Group 2843" transform="translate(-2046.804 -1563.992)" opacity="0.796">
                    <path id="Path_4902" data-name="Path 4902" d="M2075.494,1570.21l-9.506-5.381a6.518,6.518,0,0,0-6.389,0l-9.506,5.381a6.494,6.494,0,0,0-3.29,5.643v12.172a6.478,6.478,0,0,0,3.4,5.7l9.506,5.147a6.462,6.462,0,0,0,6.175,0l9.506-5.147a6.478,6.478,0,0,0,3.4-5.7v-12.172A6.493,6.493,0,0,0,2075.494,1570.21Zm1.005,17.815a4.2,4.2,0,0,1-2.2,3.693l-9.506,5.147a4.185,4.185,0,0,1-4,0l-9.506-5.147a4.2,4.2,0,0,1-2.2-3.693v-12.172a4.207,4.207,0,0,1,2.131-3.655l9.506-5.381a4.221,4.221,0,0,1,4.137,0l9.506,5.381a4.207,4.207,0,0,1,2.131,3.655Z" transform="translate(0 0)" fill="#02303b"/>
                    <path id="Path_4903" data-name="Path 4903" d="M2083.616,1598.6l-9.149,4.753a2.212,2.212,0,0,1-2.037,0l-9.15-4.753a1.071,1.071,0,0,0-1.5.576,1.1,1.1,0,0,0,.55,1.346l8.983,4.666a1.968,1.968,0,0,1,1.061,1.747v12.487a1.1,1.1,0,0,0,1.038,1.115,1.071,1.071,0,0,0,1.1-1.07v-12.532a1.969,1.969,0,0,1,1.061-1.747l8.982-4.666a1.1,1.1,0,0,0,.55-1.346A1.071,1.071,0,0,0,2083.616,1598.6Z" transform="translate(-10.655 -24.64)" fill="#02303b"/>
                </g>
            </svg>
            <span style="padding-left:10px;">Oberflächenkomplexität</span>
        </div>
        <div class="title-header">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 33.874 35.666">
             <path id="Path_4881" data-name="Path 4881" d="M981.608,4898.717H999.5a7.99,7.99,0,1,0,0-15.981H981.608a7.99,7.99,0,1,0,0,15.981Zm0-13.594a5.6,5.6,0,1,1-5.6,5.6A5.6,5.6,0,0,1,981.608,4885.123Zm17.892,17.3H981.608a7.991,7.991,0,1,0,0,15.982H999.5a7.991,7.991,0,1,0,0-15.982Zm0,13.594a5.6,5.6,0,1,1,5.6-5.6A5.6,5.6,0,0,1,999.5,4916.014Z" transform="translate(-973.617 -4882.736)" fill="#02303b" opacity="0.796"/>
            </svg>
        ...
        <div class="card_content">
            <div class="content">
                <div class="content_division">
                    <input type="text" class="product_name" v-model="productName">
                    <div>
                ...
                <div class="content_division complexity">
                    ...
                    <div>
                        <span>
                            <span style="font-weight:bold;">{{difficulty}} </span>: {{difficultyTexts[difficulty]}}
                        </span>
                    </div>
                </div>
                ...
                <div class="content_division product_variation">
                    <div style="width:100%">
                        ...
                        <span style="margin-left:8px; font-weight:500; font-size:0.9rem">Produktvarianten</span>
                    </div>
                    <div>
                        <span>
                           Ihr Produkt gibt es in mehreren Ausprägungen wie Farben, größen oder verschiedene Geometrien.
                        </span>
                    </div>
                </div>
            </div>
...
export default {
    components:{
        DifficultySelector,Counter,BaseRoundWrapper
    },
    emits:['update:_product', 'deleteProduct'],
    props:{
        _header:Boolean,
        _product:{
    ...
    data() {
        return {
           ...
           difficultyTexts:{
            ...
            medium:' Ihr Produkt ist in seine hat eine mittlere Komplexität wie z.B. Fahrrad oder Schuh.',
            hard:' /* to be provided */'
           },
        }
    },
