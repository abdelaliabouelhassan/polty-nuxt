<template>
  <div
    ...
    :style="{ borderColor: outlineColor, maxWidth: max_width }"
  >
    <div
      class=""
      :class="{ base_card_inner_wrapper: inner_border }"
...
export default {
  ...
  computed: {
    ...
    outlineColor() {
      if (this.selected) {
        return this.highlighted_c;
      } else {
        return this.outline_c;
      }
    },
  },
  mounted() {},
...
.base_card_inner_wrapper {
  margin: 1.5px;
  border-radius: 22px;
  border: 2px solid var(--primary-lite-color);
